...
import { priorityEffect } from './priority';
...
const removeTask = (task) => {
  task.option2.addEventListener('click', (e) => {
    const targetedTitle = e.target.parentElement.parentElement.parentElement.childNodes[1]
      .childNodes[0];
...
export default createTaskHtmlElements;
